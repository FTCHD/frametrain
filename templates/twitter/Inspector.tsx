...
export default function Inspector() {
    ...
    return (
        <Configuration.Root>
            <Configuration.Section title="Title" description="Configure the title of your tweet">
            ...
            <Configuration.Section title="Bottom" description="Configure the bottom of your tweet">
                <div className="flex flex-col gap-2 w-full">
            ...
            <Configuration.Section title="Tweets" description="Configure your tweets urls">
                <div className="flex flex-col gap-2 w-full">
