...
export default function CounterpartyAcceptedView(config: Config, opponentAccepted: boolean) {
    ...
    return (
        ...
        >
            ...
            >
                Wating for arbitrator @{config.arbitrator.username}'s decision {opponentAccepted}
            </div>
        </div>
    )
}
