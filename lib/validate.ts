import { getXmtpFrameMessage, isXmtpFrameActionPayload, type XmtpFrameMessageReturnType } from "frames.js/xmtp"
import type { FarcasterFramePayload, FarcasterFramePayloadValidated } from "./farcaster"
import { getLensFrameMessage, isLensFrameActionPayload, type LensFrameResponse, type LensFrameRequest } from "frames.js/lens"
import type {
...
export async function validatePayload(framePayload: FramePayload): Promise<FramePayloadValidated> {
    if (isFarcasterFrameActionPayload(framePayload)) {
